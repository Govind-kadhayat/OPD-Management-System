    ...
    <nav>
        ...
        <nav class="header">
            ...
            <ul>
                ...
                <li> <a href="#"> Que list</a></li>
                <li> <a href="#"> Contact</a></li>
                <li> <a href="#"> Admission</a></li>

            </ul>
        </nav>
        <nav class="first_page">
            <div class="fm">
                <lable class="image_text">,<h1>Welcome to OPD Management System</h1>
                    <p>An OPD is a hospital department designed to be a first contact point between the patient and the hospital staff. A Patient who goes first time to the hospital, he directly goes to OPD and then the OPD decides to which department a patient should go.
                        ...
                        Outpatient: An Outpatient is the patient who is not hospitalized for 24 hours or more but visits the hospital or clinic for treatment or diagnosis.</label>
                    </P>
                </lable>
